...
a = 100
b = 20
toplam = a + b ## a ve b değerleri toplanır.
print(toplam)
...
# # proje: gelen fiyat üzerinden kdv (%30) hesapla
# fiyat = float(input("Fiyat Girin: "))
# print(fiyat)
# kdvli_fiyat = fiyat + 30*fiyat/100
# print(kdvli_fiyat)
...
isim = "kaan"
sirket = 'ucanble'
bilgi2 = isim + " hocanın şirketinin ismi " + sirket + " " + "teknoloji" #Boşluk koyulma sebebi çıktıda bitişik halde olmasıdır.
print(bilgi2)
